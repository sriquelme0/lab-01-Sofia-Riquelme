...
1.  Based on the help file, how many rows and how many columns does the file have? What are the variables included in the data frame? Add your responses to your lab report.

There are 1846 rows with 3 variables. The variables are **dataset**, **x**, and **y**.
